...
# print("내 나이는 :",my_age)
# print("can drink alcohol :", my_age >= 20)
...
# print("Your name : ",my_name, my_name == "python", "is Correct")
# print("Your name : ",my_name, my_name != "python", "is Incorrect")
...
# numbers = map(int,input("숫자 두 개를 입력하세요 (스페이스로 구분) : ").split()) # map()을 이용해서 input값을 int형으로 변환
# print(type(numbers))
# n1,n2 = numbers # numbers는 리스트 형태이다.
# print("n1 :",n1,"/ n2 :",n2)
# print("n1 > 10 :",n1 > 10)
# print("n2 < 10 :",n2 < 10)
...
# 작은따옴표 3개로 묶거나 큰따옴표 3개로 묶기

"""### 여러 줄로 된 문자열 사용하기
"""
* 이번에는 여러 줄로 된 문자열(multiline string)을 사용해보겠습니다. 다음과 같이 작은따옴표 3개로 시작하고 Hello, world!를 입력한 다음에 
엔터 키를 누르면 다음 줄로 이동합니다. 이런 방식으로 문자열을 계속 입력하고 마지막 줄에서 작은따옴표로 닫습니다.
"""
...
지금까지 리스트를 사용해보았는데 파이썬에서는 튜플이라는 자료형도 제공합니다. 튜플은 리스트처럼 요소를 일렬로 저장하지만,
...
파이썬 프로그래밍에서 튜플을 사용하는 쪽이 더 유리한 경우도 있기 때문입니다.
